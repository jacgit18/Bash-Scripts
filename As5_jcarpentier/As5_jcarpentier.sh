...
while getopts f: opt_var1; do
    case $opt_var1 in
          f) echo "Username & Password is ${@}" >&2 ;;# displays all param passed 

#-a|--action) sudo adduser --home /home/$Username $Username ;;
        #f|--action) echo "Username & Password is ${@}" sudo adduser --home /home/$Username $Username >&2 ;;
...
sudo adduser --home /home/$Username $Username; # how to pass password=
ls /home;
